...
namespace DDD.Infrastructure.SQLite
{
    ...
    {
        internal const string ConnectionString = @"Data Source=C:\Users\user\Desktop\pupsqlite_ver_1320201\Table\DDD.db;Version=3;";
        ...
        internal static T QuerySingle<T>(string sql, Func<SQLiteDataReader, T> createEntity, T nullEntity)
        {
        ...
        internal static void Execute(string insert, string update, SQLiteParameter[] parameters)
        {
            using (var connection = new SQLiteConnection(ConnectionString))
            {
        ...
        internal static void Execute(string update, SQLiteParameter[] parameters)
        {
            using (var connection = new SQLiteConnection(ConnectionString))
            {
                using var command = new SQLiteCommand(update, connection);
